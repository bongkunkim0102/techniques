...
export const sources = [
  s('breiter1907-preface','Breiter 1907 편집자 서문과 정오표','Theodor Breiter','https://archive.org/details/mmaniliiastronom01mani','서문 III–XI, PDF 7–15쪽 및 쪽수 없는 정오표(PDF 5쪽)','Public domain: 1907년 편집 자료','서술 산문·서지·편지 인용·각주 직접 번역과 지면 대조. 이문 배열은 영인과 읽기 안내. 원필사본 조사 아님'),
  s('manilius-breiter1907','M. Manilii Astronomica, I. Carmina (1907)','Marcus Manilius; Theodor Breiter 편집','https://archive.org/details/mmaniliiastronom01mani','제1–5권 현전 인쇄 본문 전체; 실제 4,242행·695한국어 문단; PDF17–165쪽','Public domain 원전·1907년판','라틴어 지면 직접 대조. 제5권745행까지 수록. 결락·제외·난문 보존; 소실 원문 복원·필사본 전수 교감·교감란 전체 번역 완료가 아님'),
